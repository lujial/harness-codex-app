// ComfyUI AI 生图 — Client half
// 函数体（与 cordis_define 的 code.client 一致，pkg-21）。
// 提供三个设置页/浮层：
//   1. settings.section "AI 生图"（id: img-gen, order: 26）— 表单页：workflow 路径、模型、提示词、参数、预览
//   2. settings.section "ComfyUI"（id: comfyui, order: 27）— iframe 嵌入完整 ComfyUI，可全屏
//   3. shell.overlay "comfyui-full" — 全屏浮层，顶部带"独立窗口打开"与"关闭"
const CSS = `
...
.ig-model-row{display:flex;gap:8px;flex-wrap:wrap}
/* ComfyUI 设置页嵌入 */
